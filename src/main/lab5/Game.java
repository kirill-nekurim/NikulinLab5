...
public class Game {
    ...
    public Character NewHuman(JProgressBar pr1){
        Character character = new Character(0,80,16,1);
        action.HP(character, pr1);
        pr1.setMaximum(character.getMaxHealth());
        return character;
    }

    public void EndGameTop(Character character, JTextField text, JTable table) throws IOException {
        results.add(new Result(text.getText(), character.getPoints()));
    ...
    public void WriteToExcel() throws IOException{
        ...
        File f = new File("C:\\Users\\kiril\\Downloads\\Results.xlsx");
    ...
    public void ReadFromExcel() throws IOException{
        XSSFWorkbook book = new XSSFWorkbook("C:\\Users\\kiril\\Downloads\\Results.xlsx");
