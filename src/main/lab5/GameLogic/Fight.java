...
import mortalkombatbversion.src.main.lab5.Actions.Hit;
...
import mortalkombatbversion.src.main.lab5.Inside.GameResults;
import java.util.ArrayList;
import javax.swing.*;

import static mortalkombatbversion.src.main.lab5.Inside.CharacterName.SHAO_KAHN;
...
public  ArrayList<Action> actionsList = new ArrayList<>() {
    ...
    public void hit(int a, ArrayList<GameResults> gameResults, int locationsNumber, Character[] enemiesList) {
    ...
    public void checkDeath(ArrayList<GameResults> gameResults, int locationsNumber, Character[] enemiesList) {
    ...
    public void endRound(Character[] enemiesList) {
        Logic action = new Logic();
    ...
    public void reset(Character[] enemiesList) {
        Logic action = new Logic();
        player.setDamage(16);
        player.setHealth(80);
    ...
    public void endFinalRound(ArrayList<GameResults> gameResults, Character[] enemiesList) {
        Logic action = new Logic();
        action.resetEnemies(enemiesList);
