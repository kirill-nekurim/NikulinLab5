...
public class Mediator {
    ...
    public void revive(Character human, Items[] items) {
        ...
        thirdItemButton.setText(items[2].getName() + ", " + items[2].getCount() + " רע");
        playerActionLabel.setText("ֲû גמסךנוסכט");
    }
    ...
    public void setBagText(Items[] items) {
        firstItemButton.setText(items[0].getName() + ", " + items[0].getCount() + " רע");
        secondItemButton.setText(items[1].getName() + ", " + items[1].getCount() + " רע");
        thirdItemButton.setText(items[2].getName() + ", " + items[2].getCount() + " רע");
    }
