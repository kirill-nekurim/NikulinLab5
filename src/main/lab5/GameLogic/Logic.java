...
public class Logic {
    ...
    public Action chooseEnemyAction(Character enemy, ArrayList<Action> list) {
    ...
    public void levelUp(Player player, Character[] enemies) {
        player.addLevel();
        int i = 0;
    ...
    public void useItem(Character human, Items[] items, String name, Mediator mediator) {
        switch (name) {
            case "First item" -> {
    ...
    public void resetEnemies(Character[] enemiesList) {
