...
public class ChangeTexts {
    ...
    public void NewRoundTexts(Player human, Player enemy, JProgressBar pr1,
        ...
        label.setText(Integer.toString(((Character) human).getPoints()));
        label2.setText(Integer.toString(((Character) human).getExperience()) + "/" + ((Character) human).getNextExperience());
    ...
    public void EndGameText(Character character, JLabel label){
        if(character.getWin()==12){
