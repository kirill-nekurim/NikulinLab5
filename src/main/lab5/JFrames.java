...
public class JFrames extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        character = game.NewHuman(jProgressBar1);
        
        enemy = game.NewEnemy(jLabel4, jLabel5, jLabel10, jLabel13, jProgressBar2);
        
        game.change.NewRoundTexts(character, enemy, jProgressBar1, jProgressBar2,
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        game.fight.Hit(character, enemy, 1, jLabel13, jLabel12, jDialog1,
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        game.fight.Hit(character, enemy, 0, jLabel13, jLabel12, jDialog1,
                jLabel18, game.action, jProgressBar1, jProgressBar2, jDialog2, 
                jDialog4, jFrame1, game.getResults(), jLabel20, jLabel24, 
                jLabel26, jLabel29, jLabel27, items, jRadioButton3);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        enemy=game.fight.NewRound(character, jLabel4, jProgressBar1, jProgressBar2,
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            game.EndGameTop(character, jTextField1, jTable1);
        } catch (IOException ex) {
            Logger.getLogger(JFrames.class.getName()).log(Level.SEVERE, null, ex);
        }
        jDialog2.dispose();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        game.action.UseItem(character, items, nameButton, jDialog6, jDialog5);
        game.action.HP(character, jProgressBar1);
        jLabel12.setText(character.getHealth() + "/" + character.getMaxHealth());
